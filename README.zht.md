...
SumoCode 也提供桌面版應用程式。您可以直接從 [發佈頁面 (releases page)](https://github.com/anomalyco/opencode/releases) 或 [sumocode.ai/download](https://sumocode.ai/download) 下載。
...
1. `$SUMOCODE_INSTALL_DIR` - 自定義安裝目錄
...
了解更多關於 [Agents](https://sumocode.ai/docs/agents) 的資訊。

### 線上文件

關於如何設定 SumoCode 的詳細資訊，請參閱我們的 [**官方文件**](https://sumocode.ai/docs)。
...
如果您正在開發與 SumoCode 相關的專案，並在名稱中使用了 "opencode"（例如 "opencode-dashboard" 或 "opencode-mobile"），請在您的 README 中加入聲明，說明該專案並非由 SumoCode 團隊開發，且與我們沒有任何隸屬關係。
