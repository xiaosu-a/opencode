...
import { path } from "@sumocode-ai/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@sumocode-ai/core/project"
...
import { WorktreeEvent } from "@sumocode-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@sumocode/Worktree") {}
