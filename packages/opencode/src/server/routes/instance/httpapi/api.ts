...
import { makeApi } from "@sumocode-ai/protocol/api"
import { LocationMiddleware } from "@sumocode-ai/server/location"
import { SessionLocationMiddleware } from "@sumocode-ai/server/middleware/session-location"
...
export const SumoCodeHttpApi = HttpApi.make("opencode")
