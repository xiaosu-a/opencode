...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@sumocode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@sumocode/ACPDirectory") {}
