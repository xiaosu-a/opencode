...
import type { Event, GlobalEvent, OpencodeClient } from "@sumocode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@sumocode/RunStreamTransport") {}
