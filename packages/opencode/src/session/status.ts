...
import { SessionStatusEvent } from "@sumocode-ai/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@sumocode/SessionStatus") {}
