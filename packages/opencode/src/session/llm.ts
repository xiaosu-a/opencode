...
import { llmClient } from "@sumocode-ai/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@sumocode-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@sumocode-ai/llm/route"
import type { LLMClientService } from "@sumocode-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@sumocode/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @sumocode-ai/llm. It
