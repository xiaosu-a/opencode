...
import { buildPrompt } from "@sumocode-ai/core/session/compaction"
import { SessionCompactionEvent } from "@sumocode-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@sumocode/SessionCompaction") {}
