import type { JsonSchema, LLMRequest, ProviderMetadata } from "@sumocode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@sumocode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @sumocode-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
