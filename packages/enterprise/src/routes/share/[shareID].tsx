...
import { SessionTurn } from "@sumocode-ai/ui/session-turn"
...
import { MessageNav } from "@sumocode-ai/ui/message-nav"
import { FileSSR } from "@sumocode-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@sumocode-ai/ui/pierre/worker").then((m) => ({
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              ...
                              <IconButton
                                as={"a"}
                                href="https://sumocode.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
