import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@sumocode-ai/sdk/v2"
import { SessionTurn } from "@sumocode-ai/session-ui/session-turn"
import { SessionReview } from "@sumocode-ai/session-ui/session-review"
import { DataProvider } from "@sumocode-ai/session-ui/context"
import { FileComponentProvider } from "@sumocode-ai/ui/context/file"
import { WorkerPoolProvider } from "@sumocode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@sumocode-ai/ui/logo"
...
import { MessageNav } from "@sumocode-ai/session-ui/message-nav"
import { FileSSR } from "@sumocode-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@sumocode-ai/session-ui/pierre/worker").then((m) => ({
          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | SumoCode</Title>
              </Show>
