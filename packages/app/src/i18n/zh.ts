...
export const dict = {
  ...
  "wsl.onboarding.pickDistro": "请在下方选择或安装一个发行版。",
  "wsl.onboarding.checkingOpencode": "正在检查 SumoCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在 {{distro}} 中检查 SumoCode...",
  ...
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 SumoCode。",
  ...
  "settings.general.row.mobileTitlebarBottom.description": "在移动端将标题栏和会话标签放置在屏幕底部",
  ...
  "settings.general.row.newLayoutDesigns.description": "启用重新设计的布局、主页、编辑器和会话 UI",
