...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 SumoCode Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "SumoCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 SumoCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "SumoCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 SumoCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 SumoCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 sumocode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 SumoCode 服务器。",
  ...
  "toast.update.description": "SumoCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 SumoCode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (sumocode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: SumoCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "SumoCode 提供免费模型，你可以立即开始使用。",
  "sidebar.gettingStarted.line2": "连接任意提供商即可使用更多模型，如 Claude、GPT、Gemini 等。",
  "sidebar.project.recentSessions": "最近会话",
  "sidebar.project.viewAllSessions": "查看全部会话",
  "sidebar.project.clearNotifications": "清除通知",

  "app.name.desktop": "SumoCode Desktop",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 SumoCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 SumoCode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 SumoCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 SumoCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 SumoCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 SumoCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 SumoCode。",
  ...
  "error.page.description.localServerStartup": "本地服务器启动失败。通常由端口冲突或缺少依赖项引起。",
  "home.server.collapse": "收起",
  "home.server.expand": "展开",
  "language.uk": "乌克兰语",
  "session.child.backToParent": "返回父会话",
  "session.child.promptDisabled": "子会话中已禁用提示",
  "session.new.project.add": "添加项目",
  "session.new.project.new": "新建项目",
  "session.new.project.search": "搜索项目...",
  "session.new.workspace.existing": "现有工作区",
  "session.new.workspace.local": "本地",
  "session.new.workspace.runIn": "运行于",
  "session.new.workspace.triggerLocal": "触发本地",
  "session.review.noBranchChanges": "无分支变更",
  "session.review.noUncommittedChanges": "无未提交的变更",
  "settings.general.row.mobileTitlebarBottom.description": "在移动设备上将标题栏移至屏幕底部",
  "settings.general.row.mobileTitlebarBottom.title": "移动端标题栏置底",
  "settings.general.row.newLayoutDesigns.description": "启用实验性新布局设计",
  "settings.general.row.newLayoutDesigns.title": "新布局设计",
  "settings.general.row.pinchZoom.description": "在触摸屏上启用捏合缩放手势",
  "settings.general.row.pinchZoom.title": "捏合缩放",
  "settings.general.row.shell.autoDefault": "自动（默认）",
  "settings.general.row.shell.description": "终端使用的 Shell",
  "settings.general.row.shell.terminalOnly": "仅终端",
  "settings.general.row.shell.title": "Shell",
  "settings.general.row.showCustomAgents.description": "在智能体选择器中显示自定义智能体",
  "settings.general.row.showCustomAgents.title": "显示自定义智能体",
  "settings.general.row.showFileTree.description": "在会话中显示文件树面板",
  "settings.general.row.showFileTree.title": "显示文件树",
  "settings.general.row.showNavigation.description": "在顶部显示导航栏",
  "settings.general.row.showNavigation.title": "显示导航栏",
  "settings.general.row.showSearch.description": "在侧边栏中显示搜索栏",
  "settings.general.row.showSearch.title": "显示搜索栏",
  "settings.general.row.showStatus.description": "在底部显示状态栏",
  "settings.general.row.showStatus.title": "显示状态栏",
  "settings.general.row.showTerminal.description": "在会话中显示终端面板",
  ...
  "wsl.onboarding.allDistrosAdded": "所有发行版已添加",
  "wsl.onboarding.checkingDistro": "检查发行版...",
  "wsl.onboarding.checkingDistros": "检查发行版...",
  "wsl.onboarding.checkingOpencode": "检查 SumoCode...",
  "wsl.onboarding.checkingOpencodeIn": "在 {{distro}} 中检查 SumoCode...",
  "wsl.onboarding.checkingRuntime": "检查运行时...",
  "wsl.onboarding.chooseDistroFirst": "请先选择一个发行版",
  "wsl.onboarding.desktopVersion": "桌面版本",
  "wsl.onboarding.distroNotInstalled": "发行版未安装",
  "wsl.onboarding.distroReady": "发行版就绪",
  "wsl.onboarding.finishingDistro": "完成发行版设置...",
  "wsl.onboarding.install": "安装",
  "wsl.onboarding.installDistro": "安装发行版",
  "wsl.onboarding.installing": "安装中...",
  "wsl.onboarding.installingDistro": "正在安装发行版...",
  "wsl.onboarding.installOpencode": "安装 SumoCode",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 SumoCode",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.listingDistros": "列出发行版...",
  "wsl.onboarding.loadFailed": "加载失败",
  "wsl.onboarding.loading": "加载中...",
  "wsl.onboarding.next": "下一步",
  "wsl.onboarding.noDistros": "没有可用的发行版",
  "wsl.onboarding.notFound": "未找到",
  "wsl.onboarding.opencodeReady": "SumoCode 已就绪。",
  "wsl.onboarding.opencodeReadyIn": "SumoCode 已在 {{distro}} 中就绪。",
  "wsl.onboarding.openDistroOnce": "打开发行版一次以完成设置",
  "wsl.onboarding.openTerminal": "打开终端",
  "wsl.onboarding.path": "路径",
  "wsl.onboarding.pickDistro": "选择发行版",
  "wsl.onboarding.ready": "就绪",
  "wsl.onboarding.refresh": "刷新",
  "wsl.onboarding.required": "必需",
  "wsl.onboarding.restartRequired": "需要重启",
  "wsl.onboarding.step.distro": "发行版",
  "wsl.onboarding.step.sumocode": "SumoCode",
  "wsl.onboarding.toolsRequired": "需要工具",
  "wsl.onboarding.unknown": "未知",
  "wsl.onboarding.updateOpencode": "更新 SumoCode",
  "wsl.onboarding.updateOpencodeIn": "在 {{distro}} 中更新 SumoCode",
  "wsl.onboarding.updatingOpencode": "正在更新 SumoCode...",
  "wsl.onboarding.updatingOpencodeIn": "正在 {{distro}} 中更新 SumoCode...",
  "wsl.onboarding.version": "版本",
  "wsl.onboarding.versionMismatch": "版本不匹配",
  "wsl.onboarding.windowsRestartRequired": "需要重启 Windows",
