export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by SumoCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in SumoCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "SumoCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "sumocode.ai/zen",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in SumoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in SumoCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in sumocode.json",
  ...
  "dialog.server.description": "Switch which SumoCode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking SumoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking SumoCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating SumoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating SumoCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update SumoCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update SumoCode",
  "wsl.onboarding.opencodeReadyIn": "SumoCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "SumoCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install SumoCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install SumoCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen SumoCode.",
  ...
  "toast.update.description": "A new version of SumoCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the SumoCode team",
  ...
  "error.chain.checkConfig": "Check your config (sumocode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, SumoCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "SumoCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the SumoCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for SumoCode",
  ...
  "settings.general.row.appearance.description": "Customise how SumoCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether SumoCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how SumoCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when SumoCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of SumoCode.",
