...
beforeAll(async () => {
  ...
  mock.module("@sumocode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@sumocode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@sumocode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@sumocode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
