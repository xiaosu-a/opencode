...
import { Session, type Message } from "@sumocode-ai/sdk/v2/client"
...
import { toaster } from "@sumocode-ai/ui/toast"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://sumocode.ai/desktop-feedback")}
      renderPanel={() =>
