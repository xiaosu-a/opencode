...
const releaseId = process.env.SUMOCODE_RELEASE
if (!releaseId) throw new Error("SUMOCODE_RELEASE is required")

const version = process.env.SUMOCODE_VERSION
if (!version) throw new Error("SUMOCODE_VERSION is required")
