export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af SumoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af SumoCode er blevet downloadet. Vil du installere den og genstarte?",
