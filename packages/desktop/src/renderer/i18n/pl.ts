export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji SumoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} SumoCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
