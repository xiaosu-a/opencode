export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju SumoCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} SumoCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
