export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von SumoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von SumoCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
