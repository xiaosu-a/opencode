export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'SumoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'SumoCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
