export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av SumoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av SumoCode er lastet ned. Vil du installere den og starte på nytt?",
