...
import type { Plugin as PluginRuntime } from "@sumocode-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@sumocode/v2/Plugin") {}
