...
import { FileSystemWatcher } from "@sumocode-ai/schema/filesystem-watcher"
...
export class Service extends Context.Service<Service, Interface>()("@sumocode/v2/FileWatcher") {}
