...
import { ListAnchor } from "@sumocode-ai/schema/session"
...
import { SessionDurable } from "@sumocode-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@sumocode/v2/Session") {}
