...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@sumocode-ai/schema/prompt"
import { Provider } from "@sumocode-ai/schema/provider"
import { Project } from "@sumocode-ai/schema/project"
import { ProjectDirectories } from "@sumocode-ai/schema/project-directories"
import { PermissionV1 } from "@sumocode-ai/schema/permission-v1"
...
import { Command } from "@sumocode-ai/schema/command"
import { Connection } from "@sumocode-ai/schema/connection"
import { Credential } from "@sumocode-ai/schema/credential"
import { FileSystem } from "@sumocode-ai/schema/filesystem"
import { Integration } from "@sumocode-ai/schema/integration"
import { LLM } from "@sumocode-ai/schema/llm"
import { Permission } from "@sumocode-ai/schema/permission"
import { Plugin } from "@sumocode-ai/schema/plugin"
import { Pty } from "@sumocode-ai/schema/pty"
import { Reference } from "@sumocode-ai/schema/reference"
import { SessionTodo } from "@sumocode-ai/schema/session-todo"
import { Skill } from "@sumocode-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@sumocode-ai/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@sumocode-ai/core/command"),
    import("@sumocode-ai/core/integration/connection"),
    import("@sumocode-ai/core/credential"),
    import("@sumocode-ai/core/filesystem"),
    import("@sumocode-ai/core/integration"),
    import("@sumocode-ai/core/location"),
    import("@sumocode-ai/llm"),
    import("@sumocode-ai/core/permission"),
    import("@sumocode-ai/core/v1/permission"),
    import("@sumocode-ai/core/project/copy"),
    import("@sumocode-ai/core/pty"),
    import("@sumocode-ai/core/project/schema"),
    import("@sumocode-ai/core/reference"),
    import("@sumocode-ai/core/session/input"),
    import("@sumocode-ai/core/session/message"),
    import("@sumocode-ai/core/session/todo"),
    import("@sumocode-ai/core/session/prompt"),
    import("@sumocode-ai/core/skill"),
    import("@sumocode-ai/core/v2-schema"),
    import("@sumocode-ai/core/schema"),
    import("@sumocode-ai/core/workspace"),
  ])
