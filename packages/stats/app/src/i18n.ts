...
const en = {
  "app.title": "AI Model Usage Rankings | SumoCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "SumoCode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star SumoCode on GitHub",
  "header.github": "GitHub",
  "header.trySumoCode": "Try SumoCode",
  ...
  "home.topModelsDescription": "Usage of models across SumoCode Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique SumoCode Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | SumoCode Data",
  "lab.description":
    "Compare {{lab}} models used in SumoCode Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent SumoCode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in SumoCode",
  ...
  "lab.shareOfUsage": "{{share}} of recent SumoCode usage",
  "lab.usageTitle": "{{lab}} token usage",
  "lab.usageDescription": "Daily SumoCode token volume over the last two months.",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | SumoCode Data",
  "model.description":
    "View {{model}} SumoCode Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. SumoCode Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's SumoCode Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's SumoCode Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No SumoCode Go usage in the current data window.",
  ...
  "model.inputs": "Inputs",
  "model.overviewDescription": "Recent SumoCode Go tokens, unique users, and market position.",
  "model.noSummaryTitle": "No usage summary",
  "model.noSummaryDescription": "This model has no SumoCode Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily SumoCode Go token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique SumoCode Go users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average SumoCode Go session shape.",
  ...
  "model.geoDescription": "SumoCode Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No SumoCode Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent SumoCode Go token volume.",
