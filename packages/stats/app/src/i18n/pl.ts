export const dict = {
  "app.title": "Rankingi użycia modeli AI | SumoCode Data",
  "app.description":
    "Przeglądaj użycie SumoCode Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny SumoCode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę SumoCode na GitHub",
  "header.github": "GitHub",
  "header.trySumoCode": "Wypróbuj SumoCode",
  ...
  "footer.homeAria": "Strona główna SumoCode",
  ...
  "home.topModelsDescription": "Użycie modeli w SumoCode Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy SumoCode Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | SumoCode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w SumoCode Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia SumoCode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w SumoCode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia SumoCode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów SumoCode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | SumoCode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w SumoCode Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie SumoCode Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu SumoCode Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu SumoCode Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia SumoCode Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny SumoCode Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia SumoCode Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów SumoCode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy SumoCode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji SumoCode Go.",
  ...
  "model.geoDescription": "Tokeny modelu SumoCode Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne SumoCode Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów SumoCode Go.",
