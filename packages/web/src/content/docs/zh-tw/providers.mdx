...
1. 在 TUI 中執行 `/connect` 指令，選擇 `SumoCode Zen`，然後前往 [sumocode.ai/auth](https://sumocode.ai/zen)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `SumoCode Go`，然後前往 [sumocode.ai/auth](https://sumocode.ai/zen)。
