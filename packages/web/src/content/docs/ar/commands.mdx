...
أنشئ الملف `.sumocode/commands/test.md`:
...
يمكنك إضافة أوامر مخصصة عبر إعدادات SumoCode أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ SumoCode:
...
- على مستوى النظام: `~/.config/sumocode/commands/`
- لكل مشروع: `.sumocode/commands/`
