---
title: الإضافات
description: اكتب إضافاتك الخاصة لتوسيع SumoCode.
---

تتيح لك الإضافات توسيع SumoCode عبر ربطها بأحداث مختلفة وتخصيص السلوك. يمكنك إنشاء إضافات لإضافة ميزات جديدة، أو التكامل مع خدمات خارجية، أو تعديل السلوك الافتراضي لـ SumoCode.
...
- `.sumocode/plugins/` - إضافات على مستوى المشروع
- `~/.config/sumocode/plugins/` - إضافات عامة
...
1. إعدادات عامة (`~/.config/sumocode/sumocode.json`)
2. إعدادات المشروع (`sumocode.json`)
3. دليل الإضافات العام (`~/.config/sumocode/plugins/`)
4. دليل إضافات المشروع (`.sumocode/plugins/`)
...
يشغّل SumoCode الأمر `bun install` عند بدء التشغيل لتثبيتها. بعد ذلك يمكن لإضافاتك وأدواتك استيرادها.
...
:::note
إذا كنت تستخدم تطبيق SumoCode لسطح المكتب، فيمكنه إرسال إشعارات النظام تلقائيا عند جاهزية الرد أو عند حدوث خطأ في جلسة.
:::
...
المستويات: `debug`, `info`, `warn`, `error`. راجع [توثيق SDK](https://sumocode.ai/docs/sdk) للتفاصيل.
