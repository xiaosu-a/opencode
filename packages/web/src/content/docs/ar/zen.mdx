...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات SumoCode الصيغة `opencode/<model-id>`. على سبيل المثال، بالنسبة إلى GPT 5.5، ستستخدم `sumocode/gpt-5.5` في إعداداتك.
