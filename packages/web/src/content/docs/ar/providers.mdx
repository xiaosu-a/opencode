...
1. شغّل الأمر `/connect` في TUI، واختر `SumoCode Go`، ثم انتقل إلى [opencode.ai/auth](https://opencode.ai/zen).
...
1. **تحقق من إعداد auth**: شغّل `sumocode auth list` لمعرفة ما إذا كانت بيانات الاعتماد
