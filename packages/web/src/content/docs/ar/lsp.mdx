---
title: خوادم LSP
description: يتكامل SumoCode مع خوادم LSP لديك.
---

يمكن أن يتكامل SumoCode مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي SumoCode مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `SUMOCODE_DISABLE_LSP_DOWNLOAD` على `true`.
:::
