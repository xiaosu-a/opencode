---
title: TUI
description: استخدام واجهة المستخدم TUI في SumoCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر SumoCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل SumoCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة SumoCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى SumoCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من SumoCode. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `sumocode.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار SumoCode بعد الضغط على leader key. القيمة الافتراضية `2000`.
