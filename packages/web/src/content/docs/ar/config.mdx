...
يمكنك ضبط إعدادات الخادم لأوامر `sumocode serve` و`sumocode web` عبر الخيار `server`.
...
ينطبق هذا الإعداد على جميع الواجهات: TUI وCLI (`sumocode run`) وتطبيق سطح المكتب وGitHub Action.
