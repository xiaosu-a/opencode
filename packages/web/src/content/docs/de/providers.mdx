...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie SumoCode aus und gehen Sie zu [sumocode.ai/auth](https://sumocode.ai/auth).
...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `SumoCode Go` und gehen Sie zu [sumocode.ai/auth](https://sumocode.ai/zen).
