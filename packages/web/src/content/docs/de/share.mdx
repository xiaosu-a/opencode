---
title: Teilen
description: Teile SumoCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu SumoCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht SumoCode Folgendes:
...
SumoCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt SumoCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`sumocode.json` fest und committe die Datei.
