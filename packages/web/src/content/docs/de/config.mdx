...
Sie können Servereinstellungen für die Befehle `sumocode serve` und `sumocode web` über die Option `server` konfigurieren.
...
Diese Einstellung gilt für alle Schnittstellen: TUI, CLI (`sumocode run`), Desktop-App und GitHub Aktion.
