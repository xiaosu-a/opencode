...
Hier ist der vollständige ID `provider_id/model_id`. Wenn Sie beispielsweise [SumoCode Zen](/docs/zen) verwenden, würden Sie `sumocode/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
