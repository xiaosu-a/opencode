...
Die [Model-ID](/docs/config/#models) in deiner SumoCode-Konfiguration verwendet das Format `opencode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `sumocode/gpt-5.5` in deiner Konfiguration verwenden.
