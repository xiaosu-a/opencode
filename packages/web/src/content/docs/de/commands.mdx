...
Erstellen Sie `.sumocode/commands/test.md`:

```md title=".sumocode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die SumoCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem SumoCode [config](/docs/config):

```json title="sumocode.jsonc" {4-12}
{
...
- Global: `~/.config/sumocode/commands/`
- Pro Projekt: `.sumocode/commands/`

```markdown title="~/.config/sumocode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".sumocode/commands/component.md"
---
...
```md title=".sumocode/commands/create-file.md"
---
...
```md title=".sumocode/commands/analyze-coverage.md"
---
...
```md title=".sumocode/commands/review-changes.md"
---
...
```md title=".sumocode/commands/review-component.md"
---
...
SumoCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
