...
:::tip[Utenti Windows]
Per la migliore esperienza, esegui `sumocode web` da [WSL](/docs/windows-wsl) invece che da PowerShell. Questo garantisce accesso corretto al file system e integrazione col terminale.
:::
