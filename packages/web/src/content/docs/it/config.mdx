...
Puoi anche definire agenti usando file markdown in `~/.config/opencode/agents/` o `.sumocode/agents/`. [Scopri di piu](/docs/agents).
...
Puoi anche definire comandi usando file markdown in `~/.config/opencode/commands/` o `.sumocode/commands/`. [Scopri di piu](/docs/commands).
...
Metti i file dei plugin in `.sumocode/plugins/` o `~/.config/opencode/plugins/`. Puoi anche caricare plugin da npm tramite l'opzione `plugin`.
