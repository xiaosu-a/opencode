...
Puoi configurare le impostazioni del server per i comandi `sumocode serve` e `sumocode web` tramite l'opzione `server`.
...
Questa impostazione si applica a tutte le interfacce: TUI, CLI (`sumocode run`), app desktop e GitHub Action.
