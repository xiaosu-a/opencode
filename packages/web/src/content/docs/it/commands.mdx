...
Crea `.sumocode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di SumoCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di SumoCode:
...
- Globale: `~/.config/sumocode/commands/`
- Per progetto: `.sumocode/commands/`
...
sumocode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
