...
If you have `SUMOCODE_PORT` set in your environment, the desktop app will try to use that port for the local server.

- Unset `SUMOCODE_PORT` (or pick a free port) and restart.
