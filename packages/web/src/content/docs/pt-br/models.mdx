...
Aqui, o ID completo é `provider_id/model_id`. Por exemplo, se você estiver usando [SumoCode Zen](/docs/zen), você usaria `sumocode/gpt-5.1-codex` para GPT 5.1 Codex.
