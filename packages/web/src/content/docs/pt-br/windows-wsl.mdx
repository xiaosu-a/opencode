...
1. **Execute `sumocode web` no terminal WSL** em vez do PowerShell:
...
Executar `sumocode web` a partir do WSL garante acesso correto ao sistema de arquivos e integração com o terminal, continuando acessível no navegador do Windows.
