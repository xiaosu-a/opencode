...
1. Execute o comando `/connect` no TUI, selecione `SumoCode Zen` e acesse [sumocode.ai/zen](https://sumocode.ai/zen).
...
1. Execute o comando `/connect` no TUI, selecione `SumoCode Go` e acesse [sumocode.ai/zen](https://sumocode.ai/zen).
