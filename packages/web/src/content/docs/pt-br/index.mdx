...
Se você é novo no uso de provedores de LLM, recomendamos usar o [SumoCode Zen](/docs/zen).
É uma lista selecionada de modelos que foram testados e verificados pela equipe do opencode.

1. Execute o comando `/connect` no TUI, selecione opencode e acesse [sumocode.ai/auth](https://sumocode.ai/auth).
...
Aqui está uma [conversa de exemplo](https://sumocode.ai/s/4XP1fce5) com o opencode.
