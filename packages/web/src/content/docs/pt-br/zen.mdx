...
O [model id](/docs/config/#models) na sua configuração do SumoCode usa o formato `opencode/<model-id>`. Por exemplo, para GPT 5.5, você usaria `sumocode/gpt-5.5` na sua configuração.
