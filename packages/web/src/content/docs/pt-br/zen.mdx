---
title: Zen
description: Lista selecionada de modelos fornecidos pelo SumoCode.
---
...
O SumoCode Zen é uma lista de modelos testados e verificados fornecidos pela equipe do SumoCode.

O Zen funciona como qualquer outro provedor no SumoCode. Você faz login no SumoCode Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o SumoCode.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o SumoCode.
:::
...
O SumoCode Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O SumoCode Zen funciona como qualquer outro provedor no SumoCode.

1. Você faz login no **<a href={console}>SumoCode Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona SumoCode Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do SumoCode usa o formato `opencode/<model-id>`. Por exemplo, para GPT 5.5, você usaria `opencode/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no SumoCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no SumoCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- North Mini Code Free está disponível no SumoCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no SumoCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no SumoCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o SumoCode também.
