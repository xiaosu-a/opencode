...
- `.sumocode/plugins/` - Plugins em nível de projeto
- `~/.config/sumocode/plugins/` - Plugins globais
...
1. Configuração global (`~/.config/sumocode/sumocode.json`)
2. Configuração do projeto (`sumocode.json`)
3. Diretório de plugins global (`~/.config/sumocode/plugins/`)
4. Diretório de plugins do projeto (`.sumocode/plugins/`)
...
Níveis: `debug`, `info`, `warn`, `error`. Veja a [documentação do SDK](https://sumocode.ai/docs/sdk) para detalhes.
