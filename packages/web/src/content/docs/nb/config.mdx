...
Du kan konfigurere serverinnstillinger for kommandoene `sumocode serve` og `sumocode web` gjennom alternativet `server`.
...
Denne innstillingen gjelder for alle grensesnitt: TUI, CLI (`sumocode run`), skrivebordsapp og GitHub Action.
