...
Du kan også definere agenter ved å bruke markdown-filer i `~/.config/opencode/agents/` eller `.sumocode/agents/`. [Les mer her](/docs/agents).
...
Du kan også definere kommandoer ved å bruke markdown-filer i `~/.config/opencode/commands/` eller `.sumocode/commands/`. [Les mer her](/docs/commands).
...
Plasser plugin-filer i `.sumocode/plugins/` eller `~/.config/opencode/plugins/`. Du kan også laste inn plugins fra npm gjennom alternativet `plugin`.
