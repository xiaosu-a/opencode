...
Agentferdigheter lar SumoCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
sumocode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `sumocode.json`:
