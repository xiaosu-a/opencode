---
title: Deling
description: Del dine SumoCode-samtaler.
---

Delingsfunksjonen i SumoCode lar deg lage offentlige lenker til dine SumoCode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, SumoCode:
...
SumoCode støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker SumoCode manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `sumocode.json` i prosjektet ditt og sjekk det inn i Git.
