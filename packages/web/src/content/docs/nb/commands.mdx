...
Opprett `.sumocode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom SumoCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i SumoCode [config](/docs/config):
...
- Per prosjekt: `.sumocode/commands/`
...
SumoCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
