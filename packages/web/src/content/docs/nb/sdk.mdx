---
title: SDK
description: Typesikker JS-klient for SumoCode-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

SumoCode JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere SumoCode programmatisk.
...
Opprett en forekomst av SumoCode:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `sumocode.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av SumoCode, kan du opprette en klientforekomst for å koble til den:
...
```typescript
import type { Session, Message, Part } from "@sumocode-ai/sdk"
```
