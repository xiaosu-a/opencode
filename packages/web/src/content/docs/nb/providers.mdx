...
1. Kjør kommandoen `/connect` i TUI, velg `SumoCode Zen` og gå til [sumocode.ai/auth](https://sumocode.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `SumoCode Go`, og gå til [sumocode.ai/auth](https://sumocode.ai/zen).
