...
You can also define agents using markdown files in `~/.config/opencode/agents/` or `.sumocode/agents/`. [Learn more here](/docs/agents).
...
You can also define commands using markdown files in `~/.config/opencode/commands/` or `.sumocode/commands/`. [Learn more here](/docs/commands).
...
Place plugin files in `.sumocode/plugins/` or `~/.config/opencode/plugins/`. You can also load plugins from npm through the `plugin` option.
