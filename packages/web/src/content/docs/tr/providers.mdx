...
1. TUI'de `/connect` komutunu çalıştırın, opencode'u seçin ve [sumocode.ai/auth](https://sumocode.ai/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `SumoCode Go`'yu seçin ve [sumocode.ai/auth](https://sumocode.ai/zen) adresine gidin.
