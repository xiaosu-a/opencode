...
Burada tam kimlik `provider_id/model_id`'dir. Örneğin, [SumoCode Zen](/docs/zen) kullanıyorsanız, GPT 5.1 Codex için `sumocode/gpt-5.1-codex` kullanırsınız.
...
sumocode birçok sağlayıcı için varsayılan değişkenlerle birlikte gelir:
...
sumocode başlatıldığında modelleri aşağıdaki öncelik sırasına göre kontrol eder:
