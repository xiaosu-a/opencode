...
Ortamda `SUMOCODE_PORT` ayarliysa desktop uygulamasi yerel sunucu icin o portu kullanmaya calisir.

- `SUMOCODE_PORT` degerini kaldirin (veya bos bir port secin) ve yeniden baslatin
