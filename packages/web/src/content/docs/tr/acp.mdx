...
Açmak için AI Chat agent seçicisindeki yeni 'SumoCode' ajanını kullanın.
...
Ortam değişkenlerini (`SUMOCODE_API_KEY` gibi) iletmeniz gerekiyorsa, tüm ayrıntılar için CodeCompanion.nvim belgelerindeki [Configuring Adapters: Environment Variables](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key)'ye bakın.
