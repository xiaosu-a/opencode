...
Bir kullanıcı `/share` özelliğini etkinleştirirse, görüşme ve onunla ilişkili veriler, bu paylaşım sayfalarını sumocode.ai'de barındırmak için kullandığımız hizmete gönderilir.
