...
sumocode su konumlari tarar:

- Proje konfigurasyonu: `.sumocode/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/sumocode/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.sumocode/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/sumocode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.sumocode/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
`sumocode.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`sumocode.json` icinde):
