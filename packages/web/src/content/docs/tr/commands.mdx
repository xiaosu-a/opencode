...
`.sumocode/commands/test.md` oluştur:
...
sumocode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

sumocode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/sumocode/commands/`
- Proje başına: `.sumocode/commands/`
