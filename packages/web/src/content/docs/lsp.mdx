---
title: LSP Servers
description: SumoCode integrates with your LSP servers.
---

SumoCode can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

SumoCode comes with several built-in LSP servers for popular languages:
...
:::note
You can disable automatic LSP server downloads by setting the `SUMOCODE_DISABLE_LSP_DOWNLOAD` environment variable to `true`.
:::
