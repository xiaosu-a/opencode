---
title: TUI
description: Usando la interfaz de usuario del terminal SumoCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

SumoCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar SumoCode se inicia TUI para el directorio actual.
...
Cuando utilice SumoCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a SumoCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de SumoCode. _Alias_: `/quit`, `/q`
...
Esto es independiente de `sumocode.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera SumoCode después de la leader key. El valor predeterminado es `2000`.
