...
El ID del modelo en su configuración SumoCode usa el formato `provider/model-id`. Por ejemplo, si usa [SumoCode Zen](/docs/zen), usaría `opencode/gpt-5.1-codex` para GPT 5.1 Codex.
