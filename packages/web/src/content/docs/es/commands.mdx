...
Crear `.sumocode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración SumoCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su SumoCode [config](/docs/config):
...
- Por proyecto: `.sumocode/commands/`
...
sumocode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
