...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `sumocode.json`, pero puede anular o agregar configuración en línea:
