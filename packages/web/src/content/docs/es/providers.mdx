...
1. Ejecute el comando `/connect` en TUI, seleccione `SumoCode Go` y diríjase a [opencode.ai/auth](https://opencode.ai/zen).
...
1. **Verifique la configuración de autenticación**: Ejecute `sumocode auth list` para ver si las credenciales
