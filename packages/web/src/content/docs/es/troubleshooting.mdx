...
Si tiene `SUMOCODE_PORT` configurado en su entorno, la aplicación de escritorio intentará usar ese puerto para el servidor local.

- Desarme `SUMOCODE_PORT` (o elija un puerto libre) y reinicie.
