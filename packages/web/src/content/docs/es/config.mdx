...
Puede configurar los ajustes del servidor para los comandos `sumocode serve` y `sumocode web` a través de la opción `server`.
...
Esta configuración se aplica en todas las interfaces: TUI, CLI (`sumocode run`), aplicación de escritorio y GitHub Acción.
