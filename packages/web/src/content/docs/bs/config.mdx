...
Možete konfigurirati postavke servera za naredbe `sumocode serve` i `sumocode web` putem opcije `server`.
...
Ova postavka se primjenjuje na sva sučelja: TUI, CLI (`sumocode run`), desktop aplikaciju i GitHub Action.
