---
title: LSP serveri
description: SumoCode se integriše sa vašim LSP serverima.
---

SumoCode se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

SumoCode dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `SUMOCODE_DISABLE_LSP_DOWNLOAD` na `true`.
:::
