...
Kreiraj `.sumocode/commands/test.md`:
...
Možete dodati prilagođene komande kroz SumoCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom SumoCode [config](/docs/config):
...
- Globalno: `~/.config/sumocode/commands/`
- Po projektu: `.sumocode/commands/`
...
SumoCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
