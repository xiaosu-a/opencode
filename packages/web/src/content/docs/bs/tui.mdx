---
title: TUI
description: Korištenje korisničkog interfejsa SumoCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

SumoCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje SumoCode pokreće TUI za trenutni direktorij.
...
Kada koristite SumoCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u SumoCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz SumoCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `sumocode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo SumoCode čeka nakon leader key. Podrazumijevano je `2000`.
