...
Ako ste postavili `SUMOCODE_PORT` u svom okruženju, desktop aplikacija će pokušati da koristi taj port za lokalni server.

- Poništite `SUMOCODE_PORT` (ili odaberite slobodan port) i ponovo pokrenite.
...
2. **Pridružite se našem Discordu**
   ...
   [**sumocode.ai/discord**](https://sumocode.ai/discord)
