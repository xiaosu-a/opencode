...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `SumoCode Go` i idite na [opencode.ai/auth](https://opencode.ai/zen).
...
1. **Provjerite postavke autentifikacije**: Pokrenite `sumocode auth list` da vidite da li su vjerodajnice
