...
1. Run the `/connect` command in the TUI, select `SumoCode Zen`, and head to [sumocode.ai/auth](https://sumocode.ai/zen).
...
1. Run the `/connect` command in the TUI, select `SumoCode Go`, and head to [sumocode.ai/auth](https://sumocode.ai/zen).
