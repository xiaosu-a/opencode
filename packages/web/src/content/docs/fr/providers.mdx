...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `SumoCode Go` et rendez-vous sur [opencode.ai/auth](https://opencode.ai/zen).
...
1. **Vérifiez la configuration de l'authentification** : exécutez `sumocode auth list` pour voir si les informations d'identification
