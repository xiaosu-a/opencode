...
Le [model id](/docs/config/#models) dans votre configuration SumoCode utilise le format `opencode/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `sumocode/gpt-5.5` dans votre configuration.
