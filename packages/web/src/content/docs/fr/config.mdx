...
Vous pouvez configurer les paramètres du serveur pour les commandes `sumocode serve` et `sumocode web` via l'option `server`.
...
Ce paramètre s'applique à toutes les interfaces : TUI, CLI (`sumocode run`), application de bureau et GitHub Action.
