...
1. Запустите команду `/connect` в TUI, выберите `SumoCode Zen` и перейдите по адресу [sumocode.ai/auth](https://sumocode.ai/zen).
...
1. Запустите команду `/connect` в TUI, выберите `SumoCode Go` и перейдите по адресу [sumocode.ai/auth](https://sumocode.ai/zen).
