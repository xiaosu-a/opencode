...
Создайте `.sumocode/commands/test.md`:
...
- Глобальный: `~/.config/sumocode/commands/`
- Для каждого проекта: `.sumocode/commands/`
...
sumocode включает несколько встроенных команд, таких как `/init`, `/undo`, `/redo`, `/share`, `/help`; [подробнее](/docs/tui#commands).
