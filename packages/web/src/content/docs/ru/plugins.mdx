...
- `.sumocode/plugins/` – плагины уровня проекта.
- `~/.config/sumocode/plugins/` — глобальные плагины
...
1. Глобальная конфигурация (`~/.config/sumocode/sumocode.json`)
2. Конфигурация проекта (`sumocode.json`)
3. Глобальный каталог плагинов (`~/.config/sumocode/plugins/`)
4. Каталог плагинов проекта (`.sumocode/plugins/`)
...
sumocode запускает `bun install` при запуске для их установки. Затем ваши плагины и инструменты смогут импортировать их.
