...
1. TUI で `/connect` コマンドを実行し、`SumoCode Zen` を選択して、[sumocode.ai/zen](https://sumocode.ai/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`SumoCode Go` を選択して、[sumocode.ai/zen](https://sumocode.ai/zen) にアクセスします。
