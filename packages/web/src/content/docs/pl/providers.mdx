...
1. Uruchom polecenie `/connect` w TUI, wybierz `SumoCode Zen` i przejdź do [sumocode.ai/auth](https://sumocode.ai/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `SumoCode Go` i przejdź do [sumocode.ai/auth](https://sumocode.ai/zen).
