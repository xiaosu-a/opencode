...
- `.sumocode/plugins/` - Wtyczki na poziomie projektu
- `~/.config/sumocode/plugins/` - Wtyczki globalne
...
1. Konfiguracja globalna (`~/.config/sumocode/sumocode.json`)
2. Konfiguracja projektu (`sumocode.json`)
3. Globalny katalog wtyczek (`~/.config/sumocode/plugins/`)
4. Katalog wtyczek projektu (`.sumocode/plugins/`)
...
sumocode uruchomienie `bun install` przy uruchomieniu, aby je uruchomić. Twoje dodatkowe funkcje będą dostępne po zaimportowaniu.
