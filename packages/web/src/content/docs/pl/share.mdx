...
sumocode obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `sumocode.json` w swoim projekcie i sprawdź w Git.
