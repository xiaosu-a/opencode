...
Jeśli będziesz korzystać z wielu dostawców LLM, zalecamy skorzystanie z [SumoCode Zen](/docs/zen).
Aby uzyskać dostęp do wyselekcjonowanej listy modeli, które zostały zatwierdzone i zweryfikowane przez zespół opencode.

1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [sumocode.ai/auth](https://sumocode.ai/auth).
...
Oto [przykładowa rozmowa](https://sumocode.ai/s/4XP1fce5) z opencode.
