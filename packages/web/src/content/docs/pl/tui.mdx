...
Jest to oddzielny plik od `sumocode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo SumoCode czeka po naciśnięciu leader key. Domyślnie `2000`.
