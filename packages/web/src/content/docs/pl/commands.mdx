...
Utwórz `.sumocode/commands/test.md`:
...
Możesz zdefiniować polecenia w `sumocode.json` lub w plikach w katalogu `commands/`.
...
- Globalnie: `~/.config/sumocode/commands/`
- Na projekt: `.sumocode/commands/`
...
sumocode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
