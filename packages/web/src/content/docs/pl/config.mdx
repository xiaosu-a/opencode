...
Możesz skonfigurować serwer dla `sumocode serve` i `sumocode web` za pomocą opcji `server`.
...
Dotyczy to wszystkich interfejsów: TUI, CLI (`sumocode run`), aplikacji desktopowej i GitHub Actions.
