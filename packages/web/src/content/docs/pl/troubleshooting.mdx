...
Jeśli w swoim środowisku masz ustawiony `SUMOCODE_PORT`, aplikacja komputerowa spróbuje użyć tego portu dla serwera lokalnego.

- usuń `SUMOCODE_PORT` (lub wybierz wolny port) i uruchom ponownie.
