...
คุณสามารถกำหนดการตั้งค่าเซิร์ฟเวอร์สำหรับคำสั่ง `sumocode serve` และ `sumocode web` ผ่านตัวเลือก `server`
...
การตั้งค่านี้ใช้กับอินเทอร์เฟซทั้งหมด: TUI, CLI (`sumocode run`) แอปเดสก์ท็อป และ GitHub Action
