...
[model id](/docs/config/#models) ใน SumoCode config ของคุณใช้รูปแบบ `opencode/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.5 คุณจะใช้ `sumocode/gpt-5.5` ใน config ของคุณ
