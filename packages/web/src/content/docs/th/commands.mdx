...
สร้าง `.sumocode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ SumoCode:
...
- ระดับผู้ใช้ (Global): `~/.config/sumocode/commands/`
- ระดับโปรเจ็กต์: `.sumocode/commands/`
...
SumoCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
