...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก opencode และไปที่ [sumocode.ai/auth](https://sumocode.ai/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `SumoCode Go` และไปที่ [sumocode.ai/auth](https://sumocode.ai/zen)
