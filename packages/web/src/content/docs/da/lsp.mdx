---
title: LSP-servere
description: SumoCode integreres med dine LSP-servere.
---

SumoCode kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

SumoCode leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `SUMOCODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
