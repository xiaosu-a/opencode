...
1. Kør kommandoen `/connect` i TUI, vælg `SumoCode Go`, og gå til [opencode.ai/auth](https://opencode.ai/zen).
...
1. **Tjek godkendelsesopsætningen**: Kør `sumocode auth list` for at se om legitimationsoplysningerne
