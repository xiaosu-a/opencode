...
Du kan konfigurere serverindstillinger for kommandoerne `sumocode serve` og `sumocode web` gennem indstillingen `server`.
...
Denne indstilling gælder på tværs af alle grænseflader: TUI, CLI (`sumocode run`), desktop-app og GitHub Action.
