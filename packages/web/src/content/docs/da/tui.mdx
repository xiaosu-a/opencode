---
title: TUI
description: Brug af SumoCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

SumoCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre SumoCode starter TUI for den nuværende mappe.
...
Når du bruger SumoCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til SumoCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut SumoCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `sumocode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe SumoCode venter efter leader key. Standard er `2000`.
