---
title: 플러그인
description: SumoCode를 확장하기 위해 자신만의 플러그인을 작성하세요.
---
...
- `.sumocode/plugins/` - 프로젝트 레벨 플러그인
- `~/.config/sumocode/plugins/` - 글로벌 플러그인
...
1. 글로벌 구성 (`~/.config/sumocode/sumocode.json`)
2. 프로젝트 구성 (`sumocode.json`)
3. 글로벌 플러그인 디렉토리 (`~/.config/sumocode/plugins/`)
4. 프로젝트 플러그인 디렉토리 (`.sumocode/plugins/`)
...
:::note
sumocode 데스크톱 앱을 사용하는 경우 응답이 준비되어 있거나 세션 오류가 있을 때 시스템 알림을 자동으로 보낼 수 있습니다.
:::
