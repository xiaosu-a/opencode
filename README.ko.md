...
SumoCode 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/anomalyco/opencode/releases) 에서 직접 다운로드하거나 [sumocode.ai/download](https://sumocode.ai/download) 를 이용하세요.
...
1. `$SUMOCODE_INSTALL_DIR` - 사용자 지정 설치 디렉터리
...
[agents](https://sumocode.ai/docs/agents) 에 대해 더 알아보세요.

### 문서

SumoCode 설정에 대한 자세한 내용은 [**문서**](https://sumocode.ai/docs) 를 참고하세요.
...
SumoCode 와 관련된 프로젝트를 진행하면서 이름에 "opencode"(예: "opencode-dashboard" 또는 "opencode-mobile") 를 포함한다면, README 에 해당 프로젝트가 SumoCode 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.
