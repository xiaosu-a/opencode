...
import { createOpencodeClient } from "@sumocode-ai/sdk"
...
function useShareUrl() {
  return isMock() ? "https://dev.sumocode.ai" : "https://sumocode.ai"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.sumocode.ai/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.sumocode.ai/exchange_github_app_token", {
      method: "POST",
      headers: {
