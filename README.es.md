...
SumoCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/opencode/releases) o desde [sumocode.ai/download](https://sumocode.ai/download).
...
1. `$SUMOCODE_INSTALL_DIR` - Directorio de instalación personalizado
...
Más información sobre [agentes](https://sumocode.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar SumoCode, [**ve a nuestra documentación**](https://sumocode.ai/docs).
...
Si estás trabajando en un proyecto basado en SumoCode y usas "opencode" como parte del nombre, por ejemplo, "opencode-dashboard" u "opencode-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de SumoCode y que no está afiliado con nosotros de ninguna manera.
