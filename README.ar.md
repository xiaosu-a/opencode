...
يتوفر SumoCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/anomalyco/opencode/releases) او من [sumocode.ai/download](https://sumocode.ai/download).
...
1. `$SUMOCODE_INSTALL_DIR` - مجلد تثبيت مخصص
...
تعرف على المزيد حول [agents](https://sumocode.ai/docs/agents).

### التوثيق

لمزيد من المعلومات حول كيفية ضبط SumoCode، [**راجع التوثيق**](https://sumocode.ai/docs).
...
اذا كنت تعمل على مشروع مرتبط بـ SumoCode ويستخدم "opencode" كجزء من اسمه (مثل "opencode-dashboard" او "opencode-mobile")، يرجى اضافة ملاحظة في README توضح انه ليس مبنيا بواسطة فريق SumoCode ولا يرتبط بنا بأي شكل.
