...
brew install anomalyco/tap/sumocode # macOS e Linux (consigliato, sempre aggiornato)
brew install sumocode              # macOS e Linux (formula brew ufficiale, aggiornata meno spesso)
sudo pacman -S sumocode            # Arch Linux (Stable)
paru -S sumocode-bin               # Arch Linux (Latest from AUR)
mise use -g sumocode               # Qualsiasi OS
nix run nixpkgs#sumocode           # oppure github:anomalyco/sumocode per l’ultima branch di sviluppo
```
...
SumoCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/anomalyco/opencode/releases) oppure da [opencode.ai/download](https://opencode.ai/download).
...
Per maggiori informazioni su come configurare SumoCode, [**consulta la nostra documentazione**](https://opencode.ai/docs).
...
Se stai lavorando a un progetto correlato a SumoCode e che utilizza “sumocode” come parte del nome (ad esempio “sumocode-dashboard” o “sumocode-mobile”), aggiungi una nota nel tuo README per chiarire che non è sviluppato dal team SumoCode e che non è affiliato in alcun modo con noi.

---

**Unisciti alla nostra community** [Discord](https://discord.gg/sumocode) | [X.com](https://x.com/sumocode)
