...
- `SumoCode` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `SumoCode` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `SumoCode` inside commands, URLs, package names, or code literals
