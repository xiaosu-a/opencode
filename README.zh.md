...
brew install anomalyco/tap/sumocode # macOS 和 Linux（推荐，始终保持最新）
brew install sumocode              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S sumocode            # Arch Linux (Stable)
paru -S sumocode-bin               # Arch Linux (Latest from AUR)
mise use -g sumocode               # 任意系统
nix run nixpkgs#sumocode           # 或用 github:anomalyco/sumocode 获取最新 dev 分支
```
...
SumoCode 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/anomalyco/opencode/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下载。
...
SumoCode 内置两种 Agent，可用 `Tab` 键快速切换：
...
如果你在项目名中使用了 “sumocode”（如 “sumocode-dashboard” 或 “sumocode-mobile”），请在 README 里注明该项目不是 SumoCode 团队官方开发，且不存在隶属关系。

---

**加入我们的社区** [飞书](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=738j8655-cd59-4633-a30a-1124e0096789&qr_code=true) | [X.com](https://x.com/sumocode)
