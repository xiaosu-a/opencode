...
SumoCode 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/anomalyco/opencode/releases) 或 [sumocode.ai/download](https://sumocode.ai/download) 下载。
...
1. `$SUMOCODE_INSTALL_DIR` - 自定义安装目录
...
了解更多 [Agents](https://sumocode.ai/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://sumocode.ai/docs)。
...
如果你在项目名中使用了 “opencode”（如 “opencode-dashboard” 或 “opencode-mobile”），请在 README 里注明该项目不是 SumoCode 团队官方开发，且不存在隶属关系。
