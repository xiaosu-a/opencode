...
SumoCode cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/anomalyco/opencode/releases) hoặc [sumocode.ai/download](https://sumocode.ai/download).
...
1. `$SUMOCODE_INSTALL_DIR` - Thư mục cài đặt tùy chỉnh
...
Tìm hiểu thêm về [agents](https://sumocode.ai/docs/agents).

### Tài liệu

Để biết thêm thông tin về cách cấu hình SumoCode, [**hãy truy cập tài liệu của chúng tôi**](https://sumocode.ai/docs).
...
Nếu bạn đang làm việc trên một dự án liên quan đến SumoCode và sử dụng "opencode" như một phần của tên dự án, ví dụ "opencode-dashboard" hoặc "opencode-mobile", vui lòng thêm một ghi chú vào README của bạn để làm rõ rằng dự án đó không được xây dựng bởi đội ngũ SumoCode và không liên kết với chúng tôi dưới bất kỳ hình thức nào.
